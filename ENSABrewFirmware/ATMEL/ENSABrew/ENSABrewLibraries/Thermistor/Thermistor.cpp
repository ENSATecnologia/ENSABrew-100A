...
double Thermistor::getTemp() {
  ...
  /******************************************************************/
  Temp = log(Resistance);
  // Temp = 1 / (0.001129148 + (0.000234125 * Temp) + (0.0000000876741 * Temp * Temp * Temp)); //DEFAULT parameteres
  // Temp = 1 / (0.001022792758 + (0.0002530831436 * Temp) + (0.0000000003094535718 * Temp * Temp * Temp)); // 5º/25º/45º
  Temp = 1 / (0.001023713948 + (0.0002529400340 * Temp) + (0.0000000008174398416 * Temp * Temp * Temp)); // 5º/25º/100º
