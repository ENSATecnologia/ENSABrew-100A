...
// void controlKeepAlive(register uint8_t auxTypeAction)
// {
...
// void sendDataAPP(register uint8_t *auxInfoData, String *auxSendData) 
// {
// 	// ------------------------------------------------------- //
