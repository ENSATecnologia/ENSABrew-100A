...
// #include "Libraries/Arduino_PID/PID_v1.cpp"
#include "Libraries/TimerFour/TimerFour.cpp"
...
#define FINAL                    3        // FINAL do processo "statusFase" - pós-fervura
...
#define MAX_PATAMAR              30       // máximo número de PATAMARES desejado
#define MAX_TEMPERATURA_PATAMAR  255      // Temperatura máxima desejada no PATAMAR
#define MAX_MINUTO_PATAMAR       300      // Tempo máximo desejado no PATAMAR

#define MIN_OFFSET_TEMP			 -10
#define MAX_OFFSET_TEMP			 10

#define MIN_HISTERESE_FACTOR	 0// -5
#define MAX_HISTERESE_FACTOR	 5
...
#define DEFAULT_MAX_PATAMAR      30        // máximo número default de PATAMARES desejado
...
#define MAX_RECEITA              10        // MAXIMA RECEITA
...
// Máxima amostra de temperatura - Valores: (68, 75 ou 80)
#define MAX_SAMPLE_TEMPERATURE   1000       
// Quantidade default de amostras
#define DEFAULT_SAMPLE_TEMP		 (MAX_SAMPLE_TEMPERATURE / 2)


#define TIME_READ_TEMPERATURE    2 // 10		  // (*50ms)
#define TIME_SEND_TEMPERATURE 	 15       // (*1sec), se definir como 0, nunca enviará

#define INIT_TIME_INCREMENT 	 15 // 25 15  // *50ms
...
enum passosMaquina
{
	...
	mSTART_PRODUCTION    	 ,      // Passo CONTINUA PRODUCAO da máquina de estado
...
// boolean _waitWarm = false;
// Tempo de controle do SetPoint - 1 minuto
#define TIME_SET_POINT_RISE		60
// Temporizador de subida do setPoint
uint8_t wtdRiseSetPoint = 0;
// Controle da temperatura do SetPoint
float actualTempSetPoint = 0;
...
uint16_t tempFilter[MAX_SAMPLE_TEMPERATURE];
...
// ----------------------------------------------------------------------- //
// Conversão do fator de histerese

#define CONV_HIST_FT_FLOAT(auxFactor)		(auxFactor/10.0)
#define CONV_HIST_FT_INT(auxFactor)			(auxFactor*10)

// ----------------------------------------------------------------------- //
// Conversão do fator de histerese

#define CONV_OFFSET_TEMP_FLOAT(auxOffSet)		(auxOffSet/10.0)
#define CONV_OFFSET_TEMP_INT(auxOffSet)			(auxOffSet*10)
...
// Auxilia na escrita na tela durante brassagem
boolean _flagAuxBrassagem = false;
...
int8_t qtdeReceita = 0;
struct Receita 
{
	int8_t codigo = RESET;

	uint8_t qtdePatamar = DEFAULT_QT_PATAMAR;
...
struct ConfigGeral 
{
	...
	uint8_t auxPct;
	uint16_t sampleTemperature;

	// 1 segundo
	uint8_t tempoEnvioBrassagem = 1; 
	// Desabilitado por padrão
	uint8_t timeSendReadAC = 0; 

	uint8_t timeSendTemp = 0;
...
const char stMaxPatamar[] PROGMEM = "Total SetPoint";
const char stOffSetTemp[] PROGMEM = "Ajuste OffSet";
const char stHistereseFactor[] PROGMEM = "Histerese";
...
const char stSetSampleTemp[] PROGMEM = "Sensibilidade";
...
const char stWifi[] PROGMEM = "Reconectar WiFi";

const char* const menuConfig[] PROGMEM = {stVoltar, stMaxPatamar, stOffSetTemp, 
										  stHistereseFactor, stSetSampleTemp, stPwmSetpoint, 
										  stCalibracao, stResetDefault, stWifi};
...
// Se estiver utilizando display OLED
    ...
    #include "Libraries/SSD1306Ascii/src/SSD1306AsciiWire.h"
    #include "Libraries/SSD1306Ascii/src/SSD1306Ascii.cpp"
    // Instância do objeto
...
void stateMachine() 
{
  ...
  switch (passoMaquina) 
  {
    ...
    case mSET_OFFSET_TEMP: 
    	
    	configOffSet();

    	break;

    case mSET_HISTERESE_FACTOR:

    	configHistereseFactor();
...
void setup() 
{
	...
	// *Controle do tamanho de Strings

	code.reserve(3);
	stResp.reserve(4);
	stChar.reserve(17);
	stDigitado.reserve(17);
